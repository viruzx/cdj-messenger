...
function whitemode() {
    $("#app-css").attr("href", "/files/app.white.css");
    $("#foundation-css").attr("href", "/files/foundation.white.css");
    localStorage.setItem("theme", "white");
}

function blackmode() {
    $("#app-css").attr("href", "/files/app.dark.css");
    $("#foundation-css").attr("href", "/files/foundation.dark.css");
